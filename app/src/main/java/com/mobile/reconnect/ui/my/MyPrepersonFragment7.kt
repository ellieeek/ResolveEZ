...
class MyPrepersonFragment7 : BaseFragment<FragmentMyPreperson7Binding>(R.layout.fragment_my_preperson7) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addbtn.setOnClickListener {
            findNavController().navigate(R.id.action_prepersonFragment7_to_prepersonFragment8)
        }
